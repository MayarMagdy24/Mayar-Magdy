...
public class Main {
    public static void main(String[] args) {
        ...
        Undergraduate ugStudent1 = new Undergraduate("Farida", 23, "UGS101", 'A', "Law", 4);
        Graduate gStudent1 = new Graduate("Ola", 26, "GS101", 'A', 2020);

        // methods for undergraduate
        ugStudent1.displayInfo();
        ugStudent1.declareMajor();
        ugStudent1.celebrateBirthday();
        ugStudent1.study();

        // methods for graduate
